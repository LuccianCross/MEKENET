...
class SqliteTransactionRepository implements TransactionRepository {
  ...
  Future<Database> _initDatabase() async {
    ...
    final path = join(databasesPath, 'mekenet.db');
  ...
  Future<void> _onCreate(Database db, int version) async {
    ...
    await db.execute('CREATE INDEX idx_transactions_raw_sms_hash ON transactions(raw_sms_hash)');

    developer.log('Transactions table created successfully', name: 'Mekenet.DB');
  }
  ...
  Future<List<Transaction>> getByDateRange(DateTime start, DateTime end) async {
    ...
    return rows.map((map) => Transaction.fromMap(map)).toList();
  }
  ...
  @override
  Future<bool> existsBySmsHash(String rawSmsHash) async {
    final db = await _db;
